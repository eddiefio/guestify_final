...
export default function GuestHomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-spartan flex flex-col">
      <header className="bg-[#E2BFFF] shadow-sm py-3" style={{backgroundColor: '#E2BFFF'}}>
            ...
            <div className="flex flex-col space-y-3 w-full">
              ...
              <div className="grid grid-cols-2 gap-3 w-full">
                <Link href={`/guest/${propertyId}/how-things-work`} className="w-full">
                  <div className="bg-purple-100 rounded-xl p-4 shadow-sm border border-purple-300 w-full h-full">
                    <div className="mb-1">
                ...
                <Link href={`/guest/${propertyId}/before-leaving`} className="w-full">
                  <div className="bg-pink-100 rounded-xl p-4 shadow-sm border border-pink-300 w-full h-full">
                    <div className="mb-1">
                ...
                <Link href={`/guest/${propertyId}/city-guide`} className="w-full">
                  <div className="bg-yellow-100 rounded-xl p-4 shadow-sm border border-yellow-300 w-full h-full">
                    <div className="mb-1">
                ...
                <Link href={`/guest/${propertyId}/book-again`} className="w-full">
                  <div className="bg-green-100 rounded-xl p-4 shadow-sm border border-green-300 w-full h-full">
                    <div className="mb-1">
