...
import { ArrowUp, ArrowDown, Trash2, PenLine, Upload, MapPin, X, ArrowLeftIcon } from 'lucide-react'
      ...
      <Layout>
        <div className="container mx-auto px-4 py-8">
          <div className="flex justify-between items-center mb-6">
            ...
            <h1 className="text-2xl font-bold">Checkout Information</h1>
          ...
          {!loading && property ? (
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div 
                  className={`rounded-xl shadow hover:shadow-md transition p-6 cursor-pointer h-full flex flex-col items-center ${activeTab === 'checkout_time' ? 'bg-rose-100' : 'bg-rose-50 hover:bg-rose-100'}`}
                ...
                >
                  ...
                  <h2 className="text-xl font-bold text-gray-800 text-center mb-2">Checkout Time</h2>
                  <p className="text-gray-600 text-center text-sm">Information about checkout timing</p>
                </div>

                <div 
                  className={`rounded-xl shadow hover:shadow-md transition p-6 cursor-pointer h-full flex flex-col items-center ${activeTab === 'checkout_process' ? 'bg-indigo-100' : 'bg-indigo-50 hover:bg-indigo-100'}`}
                ...
                >
                  ...
                  <h2 className="text-xl font-bold text-gray-800 text-center mb-2">Checkout Process</h2>
                  <p className="text-gray-600 text-center text-sm">Instructions for checkout procedures</p>
                </div>
              </div>
