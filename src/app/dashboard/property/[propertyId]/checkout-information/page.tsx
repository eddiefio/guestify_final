...
export default function CheckoutInformation() {
  ...
  return (
    <ProtectedRoute>
      <Layout title={`Checkout Information - ${property?.name || 'Property'}`} hasBackButton backUrl={`/dashboard/property/${propertyId}/house-info`}>
          ...
          {loading ? (
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-2 md:gap-6 mb-8">
                <div 
                  className={`rounded-xl shadow hover:shadow-md transition p-2 md:p-6 cursor-pointer h-full flex flex-col items-center justify-center ${activeTab === 'checkout_time' ? 'bg-rose-100' : 'bg-rose-50 hover:bg-rose-100'}`}
                  onClick={() => setActiveTab('checkout_time')}
                >
                  <div className="text-rose-500 mb-1 md:mb-2">
                  ...
                  <h2 className="text-xs md:text-xl font-bold text-gray-800 text-center">Checkout Time</h2>
                </div>

                <div 
                  className={`rounded-xl shadow hover:shadow-md transition p-2 md:p-6 cursor-pointer h-full flex flex-col items-center justify-center ${activeTab === 'checkout_process' ? 'bg-indigo-100' : 'bg-indigo-50 hover:bg-indigo-100'}`}
                  onClick={() => setActiveTab('checkout_process')}
                >
                  <div className="text-indigo-500 mb-1 md:mb-2">
                    <svg className="w-6 h-6 md:w-12 md:h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                    </svg>
                  </div>
                  <h2 className="text-xs md:text-xl font-bold text-gray-800 text-center">Checkout Process</h2>
                </div>
              </div>
